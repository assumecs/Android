...
public class MainActivity extends Activity {
	...
	private MyImageView iv_myiv;
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_main);
		iv_myiv = (MyImageView) findViewById(R.id.iv_myiv);
	}
	
	public void left(View v){
		iv_myiv.scrollBy(10, 0);
	}
	
	public void up(View v){
		iv_myiv.scrollTo(iv_myiv.getScrollX(), iv_myiv.getScrollY()+10);
	}
	
	public void right(View v){
		iv_myiv.scrollTo(iv_myiv.getScrollX()-10, iv_myiv.getScrollY());
	}
	
	public void down(View v){
		iv_myiv.scrollBy(0, -10);
	}
	
	public void resetQuick(View v){
		iv_myiv.scrollBy(-iv_myiv.getScrollX(), -iv_myiv.getScrollY());
	}
	
	public void resetSmooth(View v){
		iv_myiv.reset();
	}
